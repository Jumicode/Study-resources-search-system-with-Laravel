...
<div class="container mx-auto px-6 py-12 space-y-12">
  ...
  <div class="flex justify-center mb-8">
    <a href="{{ route('resources.search') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition">
  ...
  <div id="video-section">
    ...
    <div id="video-container" class="relative flex space-x-6 overflow-x-auto pb-4 scroll-smooth">
  ...
  <div id="course-section">
    ...
    <div id="course-container" class="relative flex space-x-6 overflow-x-auto pb-4 scroll-smooth">
  ...
  <div id="book-section">
    ...
    <div id="book-container" class="relative flex space-x-6 overflow-x-auto pb-4 scroll-smooth">
  ...
  <div id="research-section">
    ...
    <div id="research-container" class="relative flex space-x-6 overflow-x-auto pb-4 scroll-smooth">
    ...
    <!-- Botones de scroll para Investigaciones -->
